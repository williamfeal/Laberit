...
export class UserIdentificationComponent implements OnInit, AfterViewChecked {
  ...
  private saveDraftUserIdentification() {
    ...
    // Se valida que la ruta exista para continuar con el proceso
    // si esta ruta no existe seteamos la miga siguiente que es Mi solicitud 
    // autor: @William 5 Enero 2022
    if(this.procedure.rutaFormulario == undefined){
      this.procedure.rutaFormulario = 'linea-resistir'
    }
