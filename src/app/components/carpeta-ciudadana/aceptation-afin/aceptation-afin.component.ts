...
@Component({
    selector: 'app-aceptation-afin',
    templateUrl: './aceptation-afin.component.html',
})
export class AceptationAfinComponent implements OnInit {
    ...
    constructor(
        ...
        public catalogsService: CatalogsAfinService,
        ...
        if (sessionStorage.getItem('company_type')) {
            ...
            switch (sessionStorage.getItem('company_type')) {
                case ConceptConstants.REPRESENTATIVE_PHYSIC_AUTONOMOUS:
                    company_type = ConceptConstants.DDOCS_AFIN_MANIFESTATION_AUTONOMOUS;
                    break;
                case ConceptConstants.REPRESENTATIVE_CIVIL_SOCIETY:
                    company_type = ConceptConstants.DOCS_AFIN_MANIFESTATION_CIVIL_SOCIETY;
                    break;
                case ConceptConstants.REPRESENTATIVE_COMMUNITY_OF_GOODS:
                    company_type = ConceptConstants.DOCS_AFIN_MANIFESTATION_COMUNITY_OF_GODS;
                    break;
                case ConceptConstants.REPRESENTATIVE_MICRO_BUSINESS:
                    company_type = ConceptConstants.DOCS_AFIN_MANIFESTATION_MICROEMPRESA;
                    break;
                case ConceptConstants.REPRESENTATIVE_PYME:
                    company_type = ConceptConstants.DOCS_AFIN_MANIFESTATION_PYME;        
            }
            
            this.catalogsService.getCatalogByCodeAtConcept(ConceptConstants.DOCS_AFIN_MANIFESTATION_TYPES, company_type).pipe(
