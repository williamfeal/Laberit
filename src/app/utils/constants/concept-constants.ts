export class ConceptConstants {
    public static readonly LANGUAGE_CODING_STANDARDS = "language-coding-standards";
    public static readonly ISO_6391_LANGUAGE_CODES = "iso-639-1-language-codes";
    ...
    public static readonly COUNTRIES_SPAIN = "countries-españa";
    public static readonly COUNTRIES_SPAIN_PROVINCES_3 = "countries-spain-provinces-3";
    ...
    public static readonly REPRESENTATIVE_PERSON_PHISYC = "ivf-representative-types-juridic-person";
    ...
    //public static readonly REPRESTATIVE_PHISYC_PYME = "ivf-representative-types-juridic-person-pyme";
    //public static readonly REPRESTATIVE_PHISYC_COMMUNITY_OF_GOODS = "ivf-representative-types-juridic-person-community-of-goods";
    //public static readonly REPRESTATIVE_PHISYC_CIVIL_SOCIETY = "ivf-representative-types-juridic-person-civil-society";
    public static readonly REPRESENTATIVE_PHYSIC_AUTONOMOUS = "ivf-representative-types-physical-person-autonomous";
    ...
    public static readonly LINEA_RESISTIR_GOODS_COMMUNIITY_DOCUMENTS = "linea-resistir-goods-community-documents";
    ...
    //AUTORIZATIONS
    public static readonly DATA_PROTECTION_QUESTIONARY_MANDATORY = 'data-protection-questionary-mandatory';
